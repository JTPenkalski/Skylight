...
namespace Skylight.Controllers
{
    ...
    {
        /// <inheritdoc cref="BaseController{Models.WeatherExperience, WeatherExperience}.BaseController(IConfiguration, ILogger, IMapper, IService{Models.WeatherExperience})"/>
