...
namespace Skylight.Controllers.Interfaces
{
    ...
    /// <typeparam name="TFormGuide">The type of <see cref="FormGuide"/> to be returned.</typeparam>
    public interface IFormModifiable<TModel, TFormGuide>
        ...
        where TFormGuide : FormGuide
    {
        ...
        Task<ActionResult<TFormGuide>> GetFormGuide(FormGuideRequest<TModel> request);
    }
}
