...
namespace Skylight.Models
{
    ...
    public class RiskCategoryOutlookProbability
    {
        ...
        /// </summary>
        /// <param name="type">The <see cref="WebModels.OutlookProbabilityWeatherType"/> to use for this collection.</param>
        ...
        {
            return probabilities.Select(p => new RiskCategoryOutlookProbability(type, day, p.chance, p.sigSevere)).ToHashSet();
        }
